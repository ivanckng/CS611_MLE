...
# --------------------------------
parser = argparse.ArgumentParser(description="Silver Financials Data Pipeline.")
parser.add_argument('--snapshotdate', type=str, help='The snapshot date for silver financials data pipeline (YYYY-MM-DD).')
