...
# --------------------------------
parser = argparse.ArgumentParser(description="Bronze Clickstream Data Pipeline.")
parser.add_argument('--snapshotdate', type=str, help='The snapshot date for bronze clickstream data pipeline (YYYY-MM-DD).')
