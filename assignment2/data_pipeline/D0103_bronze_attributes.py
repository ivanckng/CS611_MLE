...
# --------------------------------
parser = argparse.ArgumentParser(description="Bronze Attributes Data Pipeline.")
parser.add_argument('--snapshotdate', type=str, help='The snapshot date for bronze attributes data pipeline (YYYY-MM-DD).')
