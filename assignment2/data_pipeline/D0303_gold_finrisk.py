...
# --------------------------------
parser = argparse.ArgumentParser(description="Gold Finrisk Data Pipeline.")
parser.add_argument('--snapshotdate', type=str, help='The snapshot date for gold finrisk data pipeline (YYYY-MM-DD).')
