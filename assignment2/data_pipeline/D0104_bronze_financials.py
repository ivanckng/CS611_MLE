...
# --------------------------------
parser = argparse.ArgumentParser(description="Bronze Financials Data Pipeline.")
parser.add_argument('--snapshotdate', type=str, help='The snapshot date for bronze financials data pipeline (YYYY-MM-DD).')
