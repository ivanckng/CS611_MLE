...
# --------------------------------
parser = argparse.ArgumentParser(description="Bronze Label Data Pipeline.")
parser.add_argument('--snapshotdate', type=str, help='The snapshot date for bronze label data pipeline (YYYY-MM-DD).')
