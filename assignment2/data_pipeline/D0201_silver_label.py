...
# --------------------------------
parser = argparse.ArgumentParser(description="Silver Label Data Pipeline.")
parser.add_argument('--snapshotdate', type=str, help='The snapshot date for silver label data pipeline (YYYY-MM-DD).')
