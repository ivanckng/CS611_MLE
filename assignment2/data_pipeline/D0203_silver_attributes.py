...
# --------------------------------
parser = argparse.ArgumentParser(description="Silver Attributes Data Pipeline.")
parser.add_argument('--snapshotdate', type=str, help='The snapshot date for silver attributes data pipeline (YYYY-MM-DD).')
